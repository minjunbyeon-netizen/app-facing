...
4. **Panel B 20 칭호** — Common/Rare/Epic/Legendary 4 계층. 결정론적 임계만.
...
착용(worn)은 1개만. 해금은 누적.

#### 칭호 카탈로그 (rarity 계층)

| rarity | 수 | 대표 칭호 | 해금 조건 |
|---|---|---|---|
| Common | 6 | THE GRINDER | 세션 100회 |
| Common | | METRIC DEVOTEE | 벤치마크 5종 입력 |
| Common | | BOX MEMBER | 박스 가입 |
| Common | | COFFEE BREW | 06:00 이전 세션 10회 |
| Common | | LATE NIGHT | 22:00 이후 세션 10회 |
| Common | | WEEKEND WARRIOR | 주말 세션 20회 |
| Rare | 8 | IRON LUNG | Engine Score 80+ 5회 |
| Rare | | UNBROKEN | UB 50+ 3회 세션 |
| Rare | | DOUBLE-UNDER | DU 50 unbroken |
| Rare | | RUNNER | 5km sub-25:00 |
| Rare | | ROWER | 2km Row sub-7:30 |
| Rare | | THE TEACHER | 코치 노트 10건 발송 |
| Rare | | THE STUDENT | 코치 노트 10건 수령 |
| Rare | | HSPU MASTER | HSPU 10 unbroken |
| Epic | 4 | HEAVY | Back Squat 1RM 200kg+ |
| Epic | | THRUSTER LORD | Fran sub-3:00 |
| Epic | | RING | Muscle-up 5 unbroken |
| Epic | | COMPETITOR | CrossFit Open 등록 |
| Legendary | 2 | PRINCIPAL | Front Squat 1RM 150kg+ |
| Legendary | | SNATCH KING | Snatch 1RM 100kg+ |

해금 추론: 클라이언트 로컬 (`PanelBUnlocker.unlockedCodes`).
백엔드 trigger 의존 신호(Open 등록 여부 등)는 Phase 4 서버 통합 시 정확도 향상.
...
| Panel B 20-title Catalog | `lib/core/titles_catalog.dart` | 11 pass | 완료 |
