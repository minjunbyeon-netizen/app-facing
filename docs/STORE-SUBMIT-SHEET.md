...
| 버전 | 1.0.0 (빌드 3033) — pubspec `1.0.0+3033`. 구글 versionCode 3033 · 애플 CFBundleVersion 3033 (구 3027 = 09-04 D109·D111·D112·D113 / 구 3026 = 09-03 코치 쪽지 공지 픽스) |
...
| 빌드 | TestFlight 에 올라온 1.0.0 (3033) 선택 |
| 저작권 | 2026 변민준 |
| 버전 | 1.0.0 |
...
운영 서버 APK(1.0.0+3027 — 09-04 D109 파트·D111 통합 한 줄·D112 여닫기·D113 터치 48. 현재 산출물은 3033 = D115·D117·D118 밀림 집행분 + 수업 탭 실패 표시 픽스 + D119 줄 오른쪽 비우기)를 초기화한 뒤 실제로 눌러 본 결과. 골든 이름은 `test/golden/goldens/`.
...
2. 구글: 앱 콘텐츠 11개 항목에 초록 체크 · 앱 액세스 지침 3세트 · 스크린샷 7장 순서 · AAB 버전 3033.
