...
- [x] **앱 빌드 3010** — 2026-08-28 20:34 완료. `build/app/outputs/flutter-apk/app-release.apk`
...
- [ ] **배포 상태 (2026-08-28 20:33)** — 백엔드 `service-facing` · 관리자 웹 `web-facing-admin`
      둘 다 SUCCESS (health 200 · 로그인 200). 7·9·6·1 이 프로드에 올라가 있다.
