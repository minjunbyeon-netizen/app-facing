...
SHOTS = [
    # 2026-08-28 사용자 지시 — 다섯 가지 본연(수업 예약·공지·쪽지·업적·포인트) 순서.
    ("member_08_classes_reserved", "예약은 폰에서 한 번에", "정원·대기·취소까지"),
    ("member_02b_home_notice", "공지는 홈 맨 위에", "휴관·일정 변경을 놓치지 않게"),
    ("state_20_inbox_threads", "코치와 바로 쪽지", "자동 알림도 쪽지 하나로"),
    ("ach_02_unlock_toast", "운동이 재밌어지는 순간", "업적을 달성하면 화면이 축하한다"),
    ("member_12_achievements_all", "업적으로 남는 기록", "첫 열 번 · 3주 연속 · 첫 PR"),
    ("member_02_shell_home", "출석이 쌓이면 레벨이 오른다", "포인트·업적·마일스톤을 홈에서"),
    ("member_03_shell_profile", "회원권과 포인트를 한 곳에", "남은 기간·포인트 잔액"),
]
