    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: ListView(
          ...
          children: const [
            Text('1. 서비스', style: FacingTokens.sectionLabel),
            ...
            Text('3. 박스·회원·FACING 의 관계', style: FacingTokens.sectionLabel),
            SizedBox(height: FacingTokens.sp2),
            Text(
              'FACING 은 박스와 회원을 연결하는 도구를 제공하는 플랫폼이며, '
              '회원권 판매·환불·수업 운영의 당사자는 각 박스입니다. '
              '회원권 금액·기간·환불 조건은 박스와 회원 간 계약(전자계약서 포함)을 따르며, '
              'FACING 은 그 계약의 당사자가 아닙니다.',
              style: FacingTokens.body,
            ),
            SizedBox(height: FacingTokens.sp4),

            Text('4. 전자계약', style: FacingTokens.sectionLabel),
            SizedBox(height: FacingTokens.sp2),
            ...
            Text('5. 포인트·기록', style: FacingTokens.sectionLabel),
            SizedBox(height: FacingTokens.sp2),
            ...
            Text('8. 분쟁·관할', style: FacingTokens.sectionLabel),
            SizedBox(height: FacingTokens.sp2),
            Text(
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          const Text('·  ', style: TextStyle(color: FacingTokens.accent)),
