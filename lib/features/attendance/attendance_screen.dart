    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: FacingTokens.sp2),
          Text(
            '* XP는 현재 세션·Streak·Tier로 파생. PR 자동 연동은 Phase 2.',
